...
public class CustomListviewCircleSelectedItem extends ArrayAdapter {
    ...
    public CustomListviewCircleSelectedItem(Context context, ArrayList<HashMap<String,String>> arrayList) {
        super(context, R.layout.custom_listview_circle_selected_item, arrayList);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = layoutInflater.inflate(R.layout.custom_listview_circle_selected_item,null);
