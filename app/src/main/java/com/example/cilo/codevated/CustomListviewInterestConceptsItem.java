...
public class CustomListviewInterestConceptsItem extends ArrayAdapter {
    ...
    public CustomListviewInterestConceptsItem(Context context, ArrayList<HashMap<String,String>> arrayList) {
        super(context, R.layout.custom_listview_interest_concepts_item, arrayList);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = layoutInflater.inflate(R.layout.custom_listview_interest_concepts_item,null);
